        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    ...
                    <p class="lead">Questions ou commentaires ? Contacter nous !</p>
                </div>
                            ...
                            <div class="container">
                                <div class="contact-location">
                                    <div class="flipcard">
                                        <div class="front">
                                            <div class="top-info">
                                                <span><i class="fa fa-map-marker" aria-hidden="true"></i> Adresse du magasin</span>
                                            </div>
                                            <div class="bottom-info">
                                                <span class="top-arrow"></span>
                                                <ul>
                                                    <li>9 place du Ralliement</li>
                                                    <li>49100 Angers</li>
                                                    <li>France</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="flipcard">
                                        <div class="front">
                                            <div class="top-info">
                                                <span><i class="fa fa-fax" aria-hidden="true"></i> Téléphone</span>
                                            </div>
                                            <div class="bottom-info">
                                                <span class="top-arrow"></span>
                                                <ul>
                                                    <li><a href="+337-80-48-48-05">+337-80-48-48-05</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="back">
                                    ...
                                    <div class="flipcard">
                                        ...
                                        <div class="back">
                                            <div class="bottom-info orange-bg">
                                                <span class="bottom-arrow"></span>
                                                <ul>
                                                    <li><a href="http://www.manga++.com/">www.manga++.fr</a></li>
                                                    <li><a href="mailto:support@manga.fr">support@manga.fr</a></li>
                                                    <li><a href="mailto:info@manga.fr">info@manga++.fr</a></li>
                                                </ul>
                                            </div>
                                            <div class="top-info dark-bg">
                                                <span><i class="fa fa-envelope" aria-hidden="true"></i> Email </span>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <div class="form-group form-submit">
                                                                                <input class="btn btn-default" id="submit-contact-form" type="button" name="submit" value="Envoyer le message"  />
                                                                            </div>
                                                                        </div>
                                                                        <div id="success">
                                                                            <span>
                                                                        ...
                                                                        <div id="error">
                                                                            <span>Une erreur s'est produite, essayez d'actualiser et de renvoyer le formulaire.</span>
                                                                        </div>
                                                                    </div>
                                                                </form> 
                                                            </div>                                                                   
